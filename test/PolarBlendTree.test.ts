...
// test("setBlend: outer ring: should interpolate correctly between ...", () => {
//   const action1 = buildMockPolarAction(1, -0.5);
//   const action2 = buildMockPolarAction(1, 0.5);
//   const blendTree = new PolarBlendTreeProxy([action1, action2]);

//   blendTree.invokeSetInfluence(1);
//   const blendValue = -0.6;
//   blendTree.setBlend(1, blendValue);

//   const [expectedAction1Weight, expectedAction2Weight] =
//     lerpAngularWeightsForward(blendValue, 0.5, -0.5);

//   assertEqualWithTolerance(
//     action1.action.weight,
//     expectedAction1Weight,
//     "action1 should have ...",
//   );

//   assertEqualWithTolerance(
//     action2.action.weight,
//     expectedAction2Weight,
//     "action2 should have ...",
//   );
// });
